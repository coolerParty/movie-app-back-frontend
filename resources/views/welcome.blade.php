                ...
                <x-movie-card>
                    <x-slot name="image">
                        <a href="{{ route('movies.show', $movie->slug) }}">
                            ...
                            <div
                                class="absolute z-10 left-2 top-2 h-6 w-12 bg-gray-800 group-hover:bg-gray-700 text-blue-400 text-center font-bold rounded">
                                New
                            </div>
                            ...
                            <div class="absolute inset-0 z-8 bg-gradient-to-t from-black to-transparent"></div>
