<div class="w-full text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800">
    <div x-data="{ open: false }"
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <a class="{{ request()->routeIs('movies.index') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent dark:bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="{{ route('movies.index') }}">Movies</a>
                        <a class="{{ request()->routeIs('series.index') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent dark:bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                href="{{ route('series.index') }}">Series</a>
                        <a class="{{ request()->routeIs('casts.index') ? 'bg-gray-200 dark:bg-gray-700' : 'bg-transparent dark:bg-transparent' }} px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
            ...
            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    class="absolute z-20 right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-96">
